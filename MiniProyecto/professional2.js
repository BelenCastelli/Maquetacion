...
let displayActores = false
let displayDirectores = false
let displayGuionistas = false

function crearCard(profesionales){
    let contenedor = document.createElement("div");
    contenedor.classList.add("contendor")
...
function anadirActores(){
    ...
    if(displayActores == false) {
        card = crearCard(actors)
        actores.appendChild(card)
        displayActores = true
    } else {
        ocultarCards(actores.getElementsByClassName("card"));
        displayActores = false;
    }
}

function anadirDirectores(){
    let directores = document.getElementById("directors-content");
    if(displayDirectores == false) {
        card = crearCard(directors)
        directores.appendChild(card)
        displayDirectores = true
        
    } else {
        ocultarCards(directores.getElementsByClassName("card"));
        displayDirectores = false;
    }
}

function anadirGuionistas(){
    let guionistas = document.getElementById("writers-content");
    if(displayGuionistas == false) {
        card = crearCard(writers)
        guionistas.appendChild(card)
        displayGuionistas = true
    } else {
        ocultarCards(guionistas.getElementsByClassName("card"));
        displayGuionistas = false;
    }
}